...
public class CrawlThread extends Thread {
    private Map<String,String> lstLink;

    public CrawlThread(Map<String, String> lstLink) {
        this.lstLink = lstLink;
    }
    
    @Override
    public void run() {
        Set<Map.Entry<String, String>> entrySet = lstLink.entrySet();
        for (Map.Entry<String, String> entry : entrySet) {
            if (!checkVisited(entry.getValue())) {
                getSubCate(entry.getValue(), entry.getKey());
                addVisitLink(entry.getValue());
            }
        }
    }

    public void getSubCate(String link, String cateName) {
        try {
    ...
    public void getDataByCate(String link, String cate) {
    ...
    public void getDataByCate(String link, String cate, String subCate) {
    ...
    public void getDataItem(String linkShirt, String cate, String subCate) {
        try {
    ...
    public void getByStyle(String link, Items itemId) {
        try {
    ...
    public void getByColor(String link, Styles styleId, Items itemId, double price) {
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_SunFrogCrawl_jar_1.0-SNAPSHOTPU");
...
//                            System.out.println(link.substring(0, link.lastIndexOf("/") + 1) + split);
    ...
    public void getBySize(String link, Details details) {
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_SunFrogCrawl_jar_1.0-SNAPSHOTPU");
    ...
    public boolean checkVisited(String link) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_SunFrogCrawl_jar_1.0-SNAPSHOTPU");
        VisitedJpaController controller = new VisitedJpaController(emf);
    ...
    public void addVisitLink(String link) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_SunFrogCrawl_jar_1.0-SNAPSHOTPU");
        VisitedJpaController controller = new VisitedJpaController(emf);
